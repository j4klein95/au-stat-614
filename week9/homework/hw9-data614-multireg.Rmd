...
Becasue the p-value for EngineSize is 0.3410 (which is greater than .05), we fail to reject the null hypothesis. 
 ...
 The model with the two explanatory variables os a better model for predicting Miles per Gallon because the overall model seems to be more signficant baased on having a lower p-value (0.013 instead of 0.026)
